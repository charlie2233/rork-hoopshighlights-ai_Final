...
enum VideoImportStatusCopy {
    ...
    static let longRunningReminder = "Still saving. If iOS finished the copy, the project will be in History."
    ...
    static let timeoutRecovery = "HoopClips is still waiting. If iOS finished the copy, the project will be in History."

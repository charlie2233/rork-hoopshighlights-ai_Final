...
nonisolated enum TestFlightSmokeChecklistCopy {
    ...
    static func checklist(
        ...
        [
            ...
            "- settingsFeedbackRoute=formspree_settings_message_box",
            "- settingsFeedbackIncludes=message_category_optional_email",
            "- playerUploadProofButton=hidden_for_launch_builds",
            "longVideoProofTargets:",
            "- Fast Upload Mode state is selected before the run",
            "- compact/balanced upload optimization summary is present in app status",
            ...
            "- Settings Message us can capture issue details",
            "- app-switch handoff does not expose URLs, object keys, or local paths",
            "- Review says Analyzing, please wait while cloud is active",
            "1. Install this exact TestFlight build.",
            "2. In Settings, choose Fast Upload Mode on/off for this run.",
            ...
            "6. If upload stalls, open Settings > Message us and describe the last visible status.",
            "7. Look for compact upload, chunks saved, stale/resume hint, and app-switch handoff in the app status.",
            ...
            "12. If anything crashes or feels frozen, use Settings > Message us.",
            "13. Before filing a report, note whether the phone run passed or hit an issue.",

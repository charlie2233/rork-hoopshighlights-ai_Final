...
extension AppLanguage {
    ...
    private static let englishText: [AppTextKey: String] = [
        ...
        .supportCenterSubtitle: "Send us a note or read quick answers.",
        ...
        .settingsSmokeProofSend: "Send smoke proof",
        .settingsSmokeProofSending: "Sending smoke proof...",
        .settingsSmokeProofSent: "Smoke proof sent",
    ...
    private static let chineseText: [AppTextKey: String] = [
        ...
        .supportCenter: "需要帮助？",
        .supportCenterSubtitle: "给我们留言，或查看快速答案。",
        .aboutPrivacy: "关于与隐私",
        ...
        .settingsSmokeProofSend: "发送测试凭证",
        .settingsSmokeProofSending: "正在发送测试凭证...",
        .settingsSmokeProofSent: "测试凭证已发送",
    ...
    private static let spanishText: [AppTextKey: String] = [
        ...
        .supportCenterSubtitle: "Envíanos una nota o mira respuestas rápidas.",
        ...
        .settingsSmokeProofSend: "Enviar prueba smoke",
    ...
    private static let frenchText: [AppTextKey: String] = [
        ...
        .supportCenterSubtitle: "Écris-nous ou lis les réponses rapides.",
        ...
        .settingsSmokeProofSend: "Envoyer la preuve smoke",

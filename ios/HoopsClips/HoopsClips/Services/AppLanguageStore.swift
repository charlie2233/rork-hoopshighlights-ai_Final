...
extension AppLanguage {
    ...
    private static let englishText: [AppTextKey: String] = [
        ...
        .supportCenterSubtitle: "Ask a question, report a bug, or get quick answers.",
        ...
        .settingsSupportDetailSubtitle: "Questions, bugs, and feedback in one place.",
        ...
        .settingsContactSubtitle: "Send a note straight from HoopClips.",
        ...
        .settingsFAQSubtitle: "Short answers for the stuff people ask most.",
        ...
        .settingsSmokeProofSend: "Send crash proof",
    ...
    private static let chineseText: [AppTextKey: String] = [
        ...
        .supportCenter: "需要帮助？",
        .supportCenterSubtitle: "提问、报告问题，或查看快速答案。",
        .aboutPrivacy: "关于与隐私",
        ...
        .settingsSupportDetailSubtitle: "问题、错误报告和反馈都在这里。",
        ...
        .settingsContactSubtitle: "直接从 HoopClips 发送消息。",
    ...
    private static let spanishText: [AppTextKey: String] = [
        ...
        .supportCenterSubtitle: "Haz una pregunta, reporta un error o mira respuestas rápidas.",
        ...
        .settingsSupportDetailSubtitle: "Preguntas, errores y feedback en un solo lugar.",
        ...
        .settingsContactSubtitle: "Envía una nota directamente desde HoopClips.",
        ...
        .settingsFAQSubtitle: "Respuestas cortas a lo que más pregunta la gente.",
        ...
        .settingsSmokeProofSend: "Enviar prueba de crash",
    ...
    private static let frenchText: [AppTextKey: String] = [
        ...
        .supportCenterSubtitle: "Pose une question, signale un bug ou lis les réponses rapides.",
        ...
        .settingsSupportDetailSubtitle: "Questions, bugs et retours au même endroit.",
        ...
        .settingsContactSubtitle: "Envoie une note directement depuis HoopClips.",
        .settingsFeedbackSuggestion: "Suggestion",
        ...
        .settingsFAQSubtitle: "Réponses courtes aux questions les plus fréquentes.",
        ...
        .settingsSmokeProofSend: "Envoyer la preuve crash",

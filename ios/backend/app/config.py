...
class Settings:
    ...
    team_quick_scan_rich_candidate_clips: int = 40
    team_quick_scan_max_total_clip_frames: int = 480
...
def get_settings() -> Settings:
    ...
    settings = Settings(
        ...
        max_returned_clips=_env_int("HOOPS_MAX_RETURNED_CLIPS", 40, 8, 40),
        ...
        team_quick_scan_rich_candidate_clips=_env_int("HOOPS_TEAM_QUICK_SCAN_RICH_CANDIDATE_CLIPS", 40, 0, 120),
        team_quick_scan_max_total_clip_frames=_env_int("HOOPS_TEAM_QUICK_SCAN_MAX_TOTAL_CLIP_FRAMES", 480, 60, 600),

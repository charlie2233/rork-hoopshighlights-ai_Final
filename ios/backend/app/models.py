...
class CloudRerankTextMatch(APIModel):
    label: str = Field(min_length=1, max_length=120)
    score: float = Field(ge=0.0, le=1.0)
    promptType: Optional[str] = Field(default=None, min_length=1, max_length=80)


class CloudRerankEvidence(APIModel):
    provider: str = Field(min_length=1, max_length=80)
    model: str = Field(min_length=1, max_length=160)
    adapter: Optional[str] = Field(default=None, min_length=1, max_length=80)
    promptVersion: str = Field(min_length=1, max_length=80)
    killSwitch: bool = False
    embeddingScore: float = Field(ge=0.0, le=1.0)
    textMatches: List[CloudRerankTextMatch] = Field(default_factory=list, max_length=12)
    errorBuckets: List[str] = Field(default_factory=list, max_length=12)
    sourceIdentity: Dict[str, str] = Field(default_factory=dict)
    latencyMs: Optional[int] = Field(default=None, ge=0)
    fallbackReason: Optional[str] = Field(default=None, min_length=1, max_length=160)


class CloudClip(APIModel):
    id: Optional[str] = Field(default=None, min_length=1, max_length=120)
    clipId: Optional[str] = Field(default=None, min_length=1, max_length=120)
    startTime: float
    endTime: float
    ...
    reviewFeedbackTags: Optional[List[Literal["duplicate", "wrong_team", "bad_window", "wrong_label", "low_quality"]]] = Field(default=None, max_length=8)
    ...
    rerankEvidence: Optional[CloudRerankEvidence] = None
...
class StoredJob:
    ...
    upload_trace_id: Optional[str] = None
    inference_attempt_id: Optional[str] = None

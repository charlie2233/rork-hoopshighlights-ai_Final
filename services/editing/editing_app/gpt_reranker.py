...
AUDIO_REACTION_CONTEXT_EXPANSION_LEAD_SECONDS = 4.2
AUDIO_REACTION_CONTEXT_EXPANSION_FOLLOW_THROUGH_SECONDS = 1.6
AUDIO_REACTION_CONTEXT_EXPANSION_TARGET_SECONDS = 7.0
AUDIO_REACTION_CONTEXT_EXPANSION_MAX_SECONDS = 9.0
MIN_GPT_AUDIO_REACTION_REVIEW_SALIENCE = 0.62
...
class GPTHighlightRerankerSettings:
    ...
    def from_env(cls) -> "GPTHighlightRerankerSettings":
        return cls(
            ...
            free_max_clips=_env_int(
                ...
                _env_int("HOOPS_GPT_HIGHLIGHT_RERANK_FREE_MAX_CLIPS", 8, 1, GPT_CANDIDATE_REVIEW_LIMIT),
                1,
                GPT_CANDIDATE_REVIEW_LIMIT,
            ),
            paid_max_clips=_env_int(
                "HOOPS_AI_CLIP_GPT_MAX_CANDIDATES_PRO",
                _env_int("HOOPS_GPT_HIGHLIGHT_RERANK_PAID_MAX_CLIPS", 30, 20, GPT_CANDIDATE_REVIEW_LIMIT),
                20,
                GPT_CANDIDATE_REVIEW_LIMIT,
            ),
            free_frames_per_clip=_env_int(
                "HOOPS_AI_CLIP_GPT_FREE_KEYFRAMES_PER_CLIP",
                _env_int("HOOPS_GPT_HIGHLIGHT_RERANK_FREE_FRAMES_PER_CLIP", 3, 3, 10),
                3,
                10,
            ),
            paid_frames_per_clip=_env_int(
                "HOOPS_AI_CLIP_GPT_KEYFRAMES_PER_CLIP",
                _env_int("HOOPS_GPT_HIGHLIGHT_RERANK_PAID_FRAMES_PER_CLIP", 6, 5, 10),
                5,
                10,
            ),
    ...
    def public_status(self) -> Dict[str, Any]:
        return {
            ...
            "ai_clip_gpt_editor_enabled": self.enabled,
            "ai_clip_gpt_max_candidates_free": self.free_max_clips,
            "ai_clip_gpt_max_candidates_pro": self.paid_max_clips,
            "ai_clip_gpt_max_candidates_internal": self.paid_max_clips,
            "ai_clip_gpt_keyframes_per_clip": {
                "free": self.free_frames_per_clip,
                "pro": self.paid_frames_per_clip,
                "internal": self.paid_frames_per_clip,
            },

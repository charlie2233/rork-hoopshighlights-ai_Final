...
- `HOOPS_AI_CLIP_GPT_MAX_CANDIDATES_FREE`: Free candidate cap, clamped to `1...8`; staging default is `8`
- `HOOPS_AI_CLIP_GPT_MAX_CANDIDATES_PRO`: Pro/internal candidate cap, clamped to `20...30`; staging default is `30`
...
- `HOOPS_GPT_HIGHLIGHT_RERANK_FREE_MAX_CLIPS`: legacy Free cap override, clamped to `1...8`
- `HOOPS_GPT_HIGHLIGHT_RERANK_FREE_FRAMES_PER_CLIP`: legacy Free frames override, fixed at `3`
- `HOOPS_GPT_HIGHLIGHT_RERANK_PAID_MAX_CLIPS`: legacy Pro/internal cap, clamped to `20...30`

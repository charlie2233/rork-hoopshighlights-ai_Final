...
class EditingServiceTests(unittest.TestCase):
    ...
    def test_team_scan_endpoint_uses_editing_secret_and_redacts_source_details(self) -> None:
        ...
        self.assertEqual(prescan_settings.team_quick_scan_max_candidate_clips, 64)
        self.assertEqual(prescan_settings.team_quick_scan_clip_frames_per_clip, 6)
        self.assertEqual(prescan_settings.team_quick_scan_timeout_seconds, 90.0)

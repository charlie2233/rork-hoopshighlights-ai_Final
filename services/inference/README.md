...
- `HOOPS_INFERENCE_TEMPORAL_EVENT_DETECTOR_FAMILY_TEMPERATURE`
- `HOOPS_INFERENCE_TEMPORAL_EVENT_DETECTOR_PROPOSAL_ACCEPTANCE_THRESHOLD`
- `HOOPS_INFERENCE_TEMPORAL_EVENT_DETECTOR_PROPOSAL_ACCEPTANCE_ENERGY_THRESHOLD`

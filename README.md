...
Hoops Clips is an iOS app that turns basketball videos into share-ready highlight reels. The public launch path is on-device only: video import, Vision/CoreML analysis, review, export, and save all run locally on the phone.

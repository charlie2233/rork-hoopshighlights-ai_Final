...
- Managed object-storage proof has passed against the staging R2 bucket with scoped S3 credentials; keep those credentials out of git and rotate/re-scope before production launch as needed.

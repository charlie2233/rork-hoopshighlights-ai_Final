...
- `HOOPS_AI_CLIP_GPT_MAX_CANDIDATES_FREE`: Free candidate cap, clamped to `1...160`.
- `HOOPS_AI_CLIP_GPT_MAX_CANDIDATES_PRO`: Pro/internal candidate cap, clamped to `20...160`.
...
- Free: up to 160 candidate clips and 3 keyframes per clip.
- Pro/internal: up to 160 candidate clips and 5 to 8 keyframes per clip.

...
- `HOOPS_AI_CLIP_GPT_MAX_CANDIDATES_FREE`: Free candidate cap, clamped to `1...60`.
- `HOOPS_AI_CLIP_GPT_MAX_CANDIDATES_PRO`: Pro/internal candidate cap, clamped to `20...60`.
...
- Free: up to 60 candidate clips and 3 keyframes per clip.
- Pro/internal: up to 60 candidate clips and 5 to 8 keyframes per clip.

...
- `python3 -m unittest discover -s scripts -p 'test_*.py' -v` passed: 67 tests after the follow-up sample-size, hard-case coverage, and submission accuracy evidence gates.

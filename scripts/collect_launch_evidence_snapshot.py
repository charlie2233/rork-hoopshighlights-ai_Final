    ...
    *,
    ...
    return {
        ...
        "stableAccessibilityIdsToSmoke": [
            ...
            "history.project.resume",
            "history.project.delete",
            "history.detail.actions",
            "history.detail.resumeProject",
            "history.detail.watchSource",
            "history.detail.watchSavedReel",
            "history.detail.videoPreview",
            "history.detail.previewTitle",
            "history.detail.playback",
            "history.project.shareLatestExport",
            "history.detail.deleteProject",
...
def label_status_snapshot(repo_root: Path, label_status_path: Path, summary_path: Path | None) -> dict[str, Any]:
    ...
    if not path.exists():
        ...
        if summary_payload is not None:
            return {
                ...
                "sourceKind": summary_payload.get("sourceKind"),
                "summaryPath": str(summary_path),
                "summaryExists": summary_exists,
                "summaryGeneratedAt": summary_payload.get("generatedAt"),
                "reviewPagePath": summary_payload.get("reviewPagePath"),
                "manifestPath": summary_payload.get("manifestPath"),
                "reviewerHandoffPath": summary_payload.get("reviewerHandoffPath"),
                "executionHandoffPath": summary_payload.get("executionHandoffPath"),
    ...
    return {
        ...
        "sourceKind": "generated_label_status",
        "summaryPath": str(summary_path) if summary_path is not None else None,
        "summaryExists": False,

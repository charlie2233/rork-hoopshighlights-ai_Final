    ...
    return "\n".join(
        [
            ...
            *draft_steps,
            ...
            "6. Use `Download progress checkpoint` any time you want to save a partial session outside browser storage.",
            "7. Use `R` or `Mark reviewed + next` until the page enables `Download launch-ready labels`.",
            "8. Apply the downloaded `team_highlight_manual_labels_bundle.json`, then build the launch report.",
            "",

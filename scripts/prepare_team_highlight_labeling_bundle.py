    ...
    return "\n".join(
        [
            ...
            *draft_steps,
            ...
            "2. Use `Next close review` first, then `Next incomplete` after close-review clips are done.",
            "3. Use keyboard playback while the clip card is active: `S/E/F` jump start/event/finish, `J/L` scrub back/forward 0.5s, `K` play/pause synced angles.",
            "4. Use `P` to copy the HoopClips/GPT draft into the fields, then verify the video before accepting it.",
            "5. For obvious clips, use `1` selected-team highlight, `2` not highlight, or `3` bad window after watching the clip.",
            "6. Use `R` or `Mark reviewed + next` until the page enables `Download launch-ready labels`.",
            "7. Apply the downloaded `team_highlight_manual_labels_bundle.json`, then build the launch report.",
            "",
            "The page auto-saves a local browser draft as you label. Still download the launch-ready bundle before closing the browser.",
            "",

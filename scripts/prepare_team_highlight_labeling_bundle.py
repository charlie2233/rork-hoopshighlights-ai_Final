    ...
    return "\n".join(
        [
            ...
            *draft_steps,
            ...
            "- Every launch clip must have `expected.outcome` filled.",
            "- Every launch clip must have `needsLabel=false`.",
            "- Every launch clip must have `reviewedByHuman=true` after a person watches the source video.",

...
class LaunchBackendConfigPreflightTests(unittest.TestCase):
    ...
    def test_quality_beta_uses_full_shot_tracker_keyframe_default(self) -> None:
        ...
        self.assertEqual(REQUIRED_GPT_RERANK_SUBSTITUTIONS["_AI_CLIP_GPT_MAX_CANDIDATES_FREE"], "40")
        self.assertEqual(REQUIRED_GPT_RERANK_SUBSTITUTIONS["_AI_CLIP_GPT_MAX_CANDIDATES_PRO"], "40")
        self.assertEqual(REQUIRED_GPT_RERANK_SUBSTITUTIONS["_AI_CLIP_GPT_TIMEOUT_SECONDS"], "60")
        self.assertEqual(REQUIRED_GPT_RERANK_SUBSTITUTIONS["_AI_CLIP_GPT_MAX_OUTPUT_TOKENS"], "8000")
    ...
    def test_analysis_cloudbuild_requires_team_scan_quality_defaults(self) -> None:
        self.assertEqual(REQUIRED_ANALYSIS_TEAM_SCAN_SUBSTITUTIONS["_MAX_RETURNED_CLIPS"], "40")
        ...
        self.assertEqual(REQUIRED_ANALYSIS_TEAM_SCAN_SUBSTITUTIONS["_TEAM_QUICK_SCAN_RICH_CANDIDATE_CLIPS"], "40")
        self.assertEqual(REQUIRED_ANALYSIS_TEAM_SCAN_SUBSTITUTIONS["_TEAM_QUICK_SCAN_MAX_TOTAL_CLIP_FRAMES"], "480")
        self.assertEqual(REQUIRED_ANALYSIS_TEAM_SCAN_SUBSTITUTIONS["_TEAM_QUICK_SCAN_MAX_CANDIDATE_CLIPS"], "120")

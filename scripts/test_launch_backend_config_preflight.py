...
class LaunchBackendConfigPreflightTests(unittest.TestCase):
    ...
    def test_gpt_reranker_uses_launch_sampling_contract(self) -> None:
        ...
        self.assertEqual(REQUIRED_GPT_RERANK_SUBSTITUTIONS["_AI_CLIP_GPT_MAX_OUTPUT_TOKENS"], "24000")
    ...
    def test_analysis_cloudbuild_requires_team_scan_quality_defaults(self) -> None:
        self.assertEqual(REQUIRED_ANALYSIS_TEAM_SCAN_SUBSTITUTIONS["_MAX_RETURNED_CLIPS"], "220")
        ...
        self.assertEqual(REQUIRED_ANALYSIS_TEAM_SCAN_SUBSTITUTIONS["_TEAM_QUICK_SCAN_RICH_CANDIDATE_CLIPS"], "160")
        self.assertEqual(REQUIRED_ANALYSIS_TEAM_SCAN_SUBSTITUTIONS["_TEAM_QUICK_SCAN_MAX_TOTAL_CLIP_FRAMES"], "1760")
        self.assertEqual(REQUIRED_ANALYSIS_TEAM_SCAN_SUBSTITUTIONS["_TEAM_QUICK_SCAN_MAX_CANDIDATE_CLIPS"], "220")
